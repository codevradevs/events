        ...
        <div className="min-h-screen bg-[#07070A] text-[#F4F4F5]">
          ...
          <main className="pb-20 md:pb-0">
            <Routes>
              ...
              <Route
                path="/organizer"
                element={isAuthenticated && (user?.role === 'organizer' || user?.role === 'admin') ? <OrganizerDashboard /> : <Navigate to="/" />}
              />
              <Route
                path="/create-event"
                element={isAuthenticated && (user?.role === 'organizer' || user?.role === 'admin') ? <CreateEvent /> : <Navigate to="/" />}
              />
              <Route
                path="/admin"
