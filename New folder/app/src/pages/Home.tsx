...
export default function Home() {
  ...
  const { featuredEvents, trendingEvents } = useEventStore();
  ...
  const categories = [
    ...
    { name: 'Sports', icon: Dumbbell, image: 'https://images.unsplash.com/photo-1461896836934- voices?w=400' },
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center text-[#A1A1AA] text-sm space-x-4">
                      ...
                      <span className="flex items-center">
                        ...
                        {featuredEvents[0].location.name}
                      </span>
                    </div>
                    <Button 
                      variant="ghost" 
