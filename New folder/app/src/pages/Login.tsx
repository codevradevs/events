          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-[#A1A1AA]">
                ...
                <Link to="/register" className="text-[#B6FF2E] hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
            ...
            {/* Demo Credentials */}
            <div className="mt-8 p-4 bg-[#07070A] rounded-lg border border-white/5">
              <p className="text-xs text-[#A1A1AA] mb-2">Demo credentials:</p>
              <div className="space-y-1 text-xs">
                <p className="text-white"><span className="text-[#B6FF2E]">User:</span> spotter@example.com / StrongPass123</p>
                <p className="text-white"><span className="text-[#B6FF2E]">Admin:</span> admin@example.com / AdminPower123</p>
                <p className="text-white"><span className="text-[#B6FF2E]">Event Worker:</span> djtempo@example.com / MixItUp2024</p>
              </div>
            </div>
          </CardContent>
        </Card>
